      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6 animate-fade-in-up">
            Elevate Your
            <span className="relative whitespace-nowrap text-yellow-500 bg-clip-text bg-gradient-to-r from-pink-400 to-purple-500">
              ...
              <span className="relative"> Brand Online</span>
            </span>
          </h1>
          <p className="text-lg sm:text-xl mb-8 max-w-3xl mx-auto animate-fade-in-up animation-delay-200">
            Harness the power of social media to skyrocket your brand's online presence. Our expert strategies and cutting-edge techniques will help you connect, engage, and grow your audience across all platforms.
          </p>
